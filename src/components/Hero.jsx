  ...
  return (
    <section className="h-[60dvh] flex bg-slate-500 justify-center items-center">
      <div className="text-center space-y-8">
        <h1 className="text-2xl">Worlds Leading Short-term Storage Provider</h1>
        <form onSubmit={(e) => e.preventDefault()}>
          <div class="mb-5 flex items-cente justify-center">
            <input
              ...
              type="text"
              id="base-input"
              class="bg-gray-50 border border-gray-300 text-gray-900 text-sm focus:ring-blue-500 focus:border-blue-500 block w-80 md:w-full p-2.5 rounded-none disabled:bg-slate-300 "
